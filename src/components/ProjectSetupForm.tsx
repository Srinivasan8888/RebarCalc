...
import type { ProjectConfig, BendDeductions } from '@/types';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Typically 9 for IS code (hook length = 9 × diameter)
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-medium mb-2">Bend Deductions (multiplier × diameter)</h3>
